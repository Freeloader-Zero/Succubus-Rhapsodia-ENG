  ...
  class Succubus_registration
    ...
    def setup(race_id)
      ...
      when 251 #ユニークサキュバス/ネイジュレンジ
        @name, @graphics = "ネイジュレンジ", "boss_neijurange"
        @exp_type = 4
        @maxhp, @maxsp =  500, 400
      ...
      when 253 #ユニークサキュバス/フルビュア
        @name, @graphics = "フルビュア", "boss_fulbeua"
        @exp_type = 4
        @maxhp, @maxsp =  360, 400
      ...
      when 254 #ユニークサキュバス/ギルゴーン
        @name, @graphics = "ギルゴーン", "boss_gilgoon"
        @exp_type = 4
      ...
      when 255 #ユニークサキュバス/ユーガノット
        @name, @graphics = "ユーガノット", "boss_youganot"
        @exp_type = 4
        @maxhp, @maxsp =  320, 470
      ...
      when 256 #ユニークサキュバス/シルフェ
        @name, @graphics = "シルフェ", "boss_shilphe"
        @exp_type = 4
        @maxhp, @maxsp =  380, 380
      ...
      when 257 #ユニークサキュバス/ラーミル
        @name, @graphics = "ラーミル", "boss_rarmil"
        @exp_type = 4
        @maxhp, @maxsp = 400, 450
      ...
      when 258 #ユニークサキュバス/ヴェルミィーナ
        @name, @graphics = "ヴェルミィーナ", "boss_vermiena"
        @exp_type = 4
        @maxhp, @maxsp = 450, 450
