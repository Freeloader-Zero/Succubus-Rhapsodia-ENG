...
class Scene_Battle
  ...
  def start_phase0
    ...
    unless n > 1 
      text = $game_troop.enemies[0].name + "が現れた！"
    else
      text = $game_troop.enemies[0].name + "たちが現れた！"
    end
  ...
  def update_phase0_step1
    ...
    if $game_temp.first_attack_flag == 1
      ...
      if $game_party.actors.size == 1
        $game_temp.battle_log_text += $game_actors[101].name + "は先手を取った！\q"
      else
        $game_temp.battle_log_text += $game_actors[101].name + "たちは先手を取った！\q"
      end
      #▼システムウェイト
      case $game_system.ms_skip_mode
      when 3 #手動送りモード
    ...
    if $game_temp.first_attack_flag == 2
      ...
      $game_temp.battle_log_text = ""
      if $game_party.actors.size == 1
        $game_temp.battle_log_text += $game_actors[101].name + "は夢魔に先手を取られた！\q"
      else
        $game_temp.battle_log_text += $game_actors[101].name + "たちは夢魔に先手を取られた！\q"
      end
      #▼システムウェイト
      case $game_system.ms_skip_mode
      when 3 #手動送りモード
  ...
  def start_phase5
    ...
    if n > 1
      if $game_switches[85] == true
        $game_temp.battle_log_text = "夢魔たちを満足させた！"
      else
        $game_temp.battle_log_text = "夢魔たちを退けた！"
      end
    else
      if $game_switches[85] == true
        $game_temp.battle_log_text = "夢魔を満足させた！"
      else
        $game_temp.battle_log_text = "夢魔を退けた！"
      end
    end
